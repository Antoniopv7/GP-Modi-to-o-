    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Roles",
                columns: new[] { "Id_Rol", "Nombre", "Permisos" },
                values: new object[,]
                {
                    { 1, "Coordinador Campo Clínico Santiago", "Gestionar campos clínicos en Santiago" },
                    { 2, "Coordinador Campo Clínico Coquimbo", "Gestionar campos clínicos en Coquimbo" },
                    { 3, "Director", "Administrar todas las funciones del sistema" }
                });
