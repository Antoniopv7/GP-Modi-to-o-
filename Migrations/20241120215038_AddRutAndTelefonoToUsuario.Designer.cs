...
namespace Gestion_Del_Presupuesto.Migrations
{
    ...
    [Migration("20241120215038_AddRutAndTelefonoToUsuario")]
    partial class AddRutAndTelefonoToUsuario
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Gestion_Del_Presupuesto.Models.Rol", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id_Rol = 1,
                            Nombre = "Coordinador Campo Clínico Santiago",
                            Permisos = "Gestionar campos clínicos en Santiago"
                        },
                        new
                        {
                            Id_Rol = 2,
                            Nombre = "Coordinador Campo Clínico Coquimbo",
                            Permisos = "Gestionar campos clínicos en Coquimbo"
                        },
                        new
                        {
                            Id_Rol = 3,
                            Nombre = "Director",
                            Permisos = "Administrar todas las funciones del sistema"
                        });
                });
